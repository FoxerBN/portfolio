  ...
  return (
    <div className={className}>
      ...
      <div className={`fixed bottom-20 right-4 left-4 sm:left-auto sm:right-4 z-[100] transition-all duration-300 ${
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden max-w-md sm:max-w-xl lg:max-w-3xl mx-auto sm:mx-0 relative border border-gray-200 dark:border-gray-600">
